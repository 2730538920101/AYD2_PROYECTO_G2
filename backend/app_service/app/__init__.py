...
from app.routes import main, tarifas, clientes, conductores, administrador, asistentes, auth, viaje, oferta
...
def create_app():
    ...
    app.register_blueprint(oferta.bp, url_prefix='/api/ofertas')
