...
-   Crear un bucket de S3 y Una tabla de DynamoDB para el backend del proyecto de terraform y poder guardar y bloquear los states de la infraestructura
    - ["Manual para crear un backend de terraform"](https://spacelift.io/blog/terraform-s3-backend)
